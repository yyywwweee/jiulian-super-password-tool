# Vendored from CPython 3.12 Lib/telnetlib.py.
# Original license: Python Software Foundation License.
# Source: https://github.com/python/cpython/blob/3.12/Lib/telnetlib.py
# Vendored because stdlib telnetlib was removed in Python 3.13+.
